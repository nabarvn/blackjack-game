...
function blackjackDeal() {
  if (blackjackGame['turnsOver'] === true) {
    ...
    let yourImages = document.querySelector('#your-box').querySelectorAll('img'); //It's an Array
    let dealerImages = document.querySelector('#dealer-box').querySelectorAll('img'); //It's an Array
